...
<nav class="navbar navbar-expand navbar-primary flex-column flex-md-row bd-navbar bg-primary">
    ...
    <div class="navbar-nav" id="navbarNav">
        <ul class="navbar-nav flex-row ml-md-auto d-none d-md-flex">
            <li class="nav-item">
                <a class="nav-link" href="pageMesprojet.html">Projet<span class="sr-only">(current)</span></a>
            </li>
            <li class="nav-item">
                <a class="nav-link" href="#lol">Aide<span class="sr-only">(current)</span></a>
            </li>
            <li class="nav-item ">
                <a class="nav-link" href="credit.html">Credit<span class="sr-only">(current)</span></a>
            </li>
        </ul>
    </div>
</nav>
        ...
        <div class="form-group mb-3 mx-auto">
            <form action="index.php?action=SeConnecter" method="post">
                ...
                <div class="row g-3 align-items-center">
                    <div class="col-auto">
                        <input class="form-control" placeholder="Prenom" required>
                    </div>
                    <div class="col-auto">
                        <input class="form-control" placeholder="Nom" required>
                    </div>
                </div>
                <input type="password" class="form-control mt-3 mb-3" placeholder="Mot de passe" required>
                <input type="password" class="form-control mt-3 mb-3" placeholder="Entrez à nouveau votre mot de passe" required name="mdp">
